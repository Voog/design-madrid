:root {
  /* VoogStyle
     "pathI18n": ["custom_styles.blog_list"],
  ...
  */
  ...
  /* VoogStyle
     "pathI18n": ["custom_styles.blog_list", "custom_styles.headings"],
  ...
  */
  ...
  /* VoogStyle
     "pathI18n": ["custom_styles.blog_list", "Date"],
     "titleI18n": "custom_styles.font",
     "editor": "listPicker",
     "list": {{ base_font_set }},
     "featured": true,
