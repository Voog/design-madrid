...
return 600>c?"凌晨":900>c?"早上":1130>c?"上午":1230>c?"中午":1800>c?"下午":"晚上"},calendar:{sameDay:function(){return 0===this.minutes()?"[今天]Ah[点整]":"[今天]LT"},nextDay:function(){return 0===this.minutes()?"[明天]Ah[点整]":"[明天]LT"},lastDay:function(){return 0===this.minutes()?"[昨天]Ah[点整]":"[昨天]LT"},nextWeek:function(){var b,c;return b=a().startOf("week"),c=this.unix()-b.unix()>=604800?"[下]":"[本]",0===this.minutes()?c+"dddAh点整":c+"dddAh点mm"},lastWeek:function(){var b,c;return b=a().startOf("week"),c=this.unix()<b.unix()?"[上]":"[本]",0===this.minutes()?c+"dddAh点整":c+"dddAh点mm"},sameElse:"LL"},ordinal:function(a,b){switch(b){case"d":case"D":case"DDD":return a+"日";case"M":return a+"月";case"w":case"W":return a+"周";default:return a}},relativeTime:{future:"%s内",past:"%s前",s:"几秒",m:"1分钟",mm:"%d分钟",h:"1小时",hh:"%d小时",d:"1天",dd:"%d天",M:"1个月",MM:"%d个月",y:"1年",yy:"%d年"},week:{dow:1,doy:4}})}),function(a){a(tb)}(function(a){return a.defineLocale("zh-tw",{months:"一月_二月_三月_四月_五月_六月_七月_八月_九月_十月_十一月_十二月".split("_"),monthsShort:"1月_2月_3月_4月_5月_6月_7月_8月_9月_10月_11月_12月".split("_"),weekdays:"星期日_星期一_星期二_星期三_星期四_星期五_星期六".split("_"),weekdaysShort:"週日_週一_週二_週三_週四_週五_週六".split("_"),weekdaysMin:"日_一_二_三_四_五_六".split("_"),longDateFormat:{LT:"Ah點mm",L:"YYYY年MMMD日",LL:"YYYY年MMMD日",LLL:"YYYY年MMMD日LT",LLLL:"YYYY年MMMD日ddddLT",l:"YYYY年MMMD日",ll:"YYYY年MMMD日",lll:"YYYY年MMMD日LT",llll:"YYYY年MMMD日ddddLT"},meridiem:function(a,b){var c=100*a+b;return 900>c?"早上":1130>c?"上午":1230>c?"中午":1800>c?"下午":"晚上"},calendar:{sameDay:"[今天]LT",nextDay:"[明天]LT",nextWeek:"[下]ddddLT",lastDay:"[昨天]LT",lastWeek:"[上]ddddLT",sameElse:"L"},ordinal:function(a,b){switch(b){case"d":case"D":case"DDD":return a+"日";case"M":return a+"月";case"w":case"W":return a+"週";default:return a}},relativeTime:{future:"%s內",past:"%s前",s:"幾秒",m:"一分鐘",mm:"%d分鐘",h:"一小時",hh:"%d小時",d:"一天",dd:"%d天",M:"一個月",MM:"%d個月",y:"一年",yy:"%d年"}})}),tb.locale("en"),Jb?module.exports=tb:"function"==typeof define&&define.amd?(define("moment",function(a,b,c){return c.config&&c.config()&&c.config().noGlobal===!0&&(xb.moment=ub),tb}),sb(!0)):sb()}).call(this),function(a){var b={template:"#article-template",perPage:3,dateFormat:function(a){return moment(a.getFullYear()+"-"+(a.getMonth()+1)+"-"+a.getDate(),"YYYY-MM-DD").locale(langCode).format("LL")},dateAttrFormat:function(a){return a.getFullYear()+"-"+(a.getMonth()+1)+"-"+a.getDate()},older:"older &gt;",newer:"&lt; newer"},c=function(b,c){var d=b;return a.each(c,function(a,b){d=d.replace(new RegExp("\\[\\["+a+"\\]\\]","g"),b)}),d},d=function(c,d){this.$el=c,this.currentPage=1,this.options=a.extend(b,d)};d.prototype={init:function(){this.showPage(this.currentPage)},fetch:function(b,c){this.$el.trigger("articles.loading");var d=this.options.tags?"tag[]="+this.options.tags.join("&tag[]=")+"&":"",e=this.options.page_id?"page_id="+this.options.page_id:"",f="/admin/api/articles.json?"+d+"page="+b+"&per_page="+this.options.perPage+"&"+e+"&include_details=true";a.ajax({url:f,dataType:"json",success:a.proxy(function(a){this.$el.trigger("articles.loaded"),c(0==a.length?null:a)},this),error:a.proxy(function(){this.$el.trigger("articles.loaded"),this.$el.trigger("articles.error"),c(null)},this)})},render:function(b){if(b&&(this.$el.html(""),a.each(b,a.proxy(function(b,d){this.$el.append(c(a(this.options.template).html(),{url:d.public_url,title:d.title,excerpt:d.excerpt,date:this.options.dateFormat(new Date(d.created_at)),dateAttr:this.options.dateAttrFormat(new Date(d.created_at)),author:d.author,body:d.body}))},this)),this.$pageLinks)){this.$pageLinks.find(".js-pagination-item.visible").removeClass("visible").addClass("hidden"),this.$pageLinks.find(".js-pagination-item.active").removeClass("active").addClass("hidden"),this.$pageLinks.find('.js-pagination-link[data-page="'+this.currentPage+'"]').parent().addClass("active").removeClass("hidden");for(var d=Math.max(this.currentPage-3,0);d<this.currentPage;d++)this.$pageLinks.find('.js-pagination-link[data-page="'+d+'"]').parent().addClass("visible").removeClass("hidden");for(var e=this.currentPage+1;e<this.currentPage+5;e++)this.$pageLinks.find('.js-pagination-link[data-page="'+e+'"]').parent().addClass("visible").removeClass("hidden");var f=a(".js-pagination-item");f.first().hasClass("active")?(a(".js-pagination-next").removeClass("disabled"),a(".js-pagination-previous").addClass("disabled")):f.last().hasClass("active")?(a(".js-pagination-previous").removeClass("disabled"),a(".js-pagination-next").addClass("disabled")):a(".js-pagination-previous, .js-pagination-next").removeClass("disabled")}},next:function(){(!this.options.articles_count||this.currentPage<Math.ceil(this.options.articles_count/this.options.perPage))&&this.fetch(this.currentPage+1,a.proxy(function(a){a&&(this.currentPage+=1,this.render(a))},this))},prev:function(){this.currentPage>1&&this.fetch(this.currentPage-1,a.proxy(function(a){a&&(this.currentPage-=1,this.render(a))},this))},showPage:function(b){this.fetch(b,a.proxy(function(a){a&&(this.currentPage=b,this.render(a))},this))},getPageLinks:function(){if(!this.$pageLinks){var b=a('<nav class="menu-pagination js-menu-pagination"><div class="wrap"><ul class="menu js-menu"></ul></div></nav>');if(b.find(".wrap").prepend(a('<div class="menu-item pagination-previous js-pagination-btn js-pagination-previous disabled"><a class="menu-link" href="#">'+this.options.newer+"</a></div>").click(a.proxy(function(a){a.preventDefault(),this.prev()},this))),this.options.articles_count)for(var c=Math.ceil(this.options.articles_count/this.options.perPage),d=1;c>=d;d++)b.find(".menu").append(a('<li class="menu-item js-pagination-item hidden"><a class="menu-link js-pagination-link" href="#" data-page="'+d+'">'+d+"</a></li>").click(a.proxy(function(b){b.preventDefault(),this.showPage(parseInt(a(b.target).data("page"),10))},this)));b.find(".wrap").append(a('<div class="menu-item pagination-next js-pagination-btn js-pagination-next"><a class="menu-link" href="#">'+this.options.older+"</a></div>").click(a.proxy(function(a){a.preventDefault(),this.next()},this))),this.$pageLinks=b}this.$pageLinks.find(".js-pagination-item.visible").removeClass("visible").addClass("hidden"),this.$pageLinks.find(".js-pagination-item.active").removeClass("active").addClass("hidden"),this.$pageLinks.find('.js-pagination-link[data-page="'+this.currentPage+'"]').parent().addClass("active").removeClass("hidden");for(var e=Math.max(this.currentPage-3,0);e<this.currentPage;e++)this.$pageLinks.find('.js-pagination-link[data-page="'+e+'"]').parent().addClass("visible").removeClass("hidden");for(var f=this.currentPage+1;f<this.currentPage+5;f++)this.$pageLinks.find('.js-pagination-link[data-page="'+f+'"]').parent().addClass("visible").removeClass("hidden");return this.$pageLinks}},a.fn.articlePages=function(b,c){if(!b||"string"!=typeof b)return this.each(function(){if(!a(this).data("article-pages")){var c=new d(a(this),b);a(this).data("article-pages",c)}});switch(b){case"getObject":return a(this).data("article-pages");case"next":a(this).data("article-pages").next();break;case"prev":a(this).data("article-pages").prev();break;case"showPage":c&&a(this).data("article-pages").showPage(c);break;case"getPageLinks":return a(this).data("article-pages").getPageLinks()}}}(jQuery);